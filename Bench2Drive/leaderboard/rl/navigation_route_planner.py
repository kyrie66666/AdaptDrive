"""Route planner for generic AdaptDrive environment observations.

The behavior is preserved from the original Bench2DriveZoo planner so replay
navigation semantics stay unchanged after removing that external dependency.
"""
