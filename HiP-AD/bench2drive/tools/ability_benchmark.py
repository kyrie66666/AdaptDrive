...
def main(args):
    ...
    print(f'Total Route num in XML: {len(sorted_routes)}, Result Route num: {int(Route_num)}, Crashed/Missing Route num: {len(crash_route_list)}')
    if crash_route_list:
        print(f'Crashed/Missing Route ID: {crash_route_list}')
    print('Finished!')
