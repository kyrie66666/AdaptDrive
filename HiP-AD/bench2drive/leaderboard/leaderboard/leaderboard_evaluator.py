...
class LeaderboardEvaluator(object):
    ...
    def _cleanup(self):
        ...
        # Make sure no sensors are left streaming. World loading can fail before
        # self.world is assigned; cleanup should preserve the original failure.
    ...
    def _setup_simulation(self, args):
        ...
        """
        self._sim_backend = SimulationBackend(
            build_simulation_config_from_args(
                args,
